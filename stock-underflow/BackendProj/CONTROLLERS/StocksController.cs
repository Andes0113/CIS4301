...
namespace $safeprojectname$.Controllers
{
    public class StocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ticker,CompanyName")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ticker,CompanyName")] Stock stock)
        {
            if (id != stock.Id)
            {
                return NotFound();
